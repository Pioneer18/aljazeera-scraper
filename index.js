  ...
  app.get("/scrape", function(req,response){
    ...
    axios.get("https://www.aljazeera.com/news/").then(function(response) {
      ...
      $("div.top-section-lt").each(function(i, element) {
        ...
        var link = "https://www.aljazeera.com" + $(element).find("div.top-feature-overlay-cont").children("a").children("a").attr("href");
      ...
      $("div.top-section-rt-s1").each(function(i, element) {
        ...
        // In the currently selected element, look at its child elements (i.e., its a-tags),
        // then save the values for any "href" attributes that the child elements may have
        var title = $(element).find("div.topFeature-sblock-wr").children("a").children("h2").text();
        var link = "https://www.aljazeera.com" + $(element).find("div.topFeature-sblock-wr").children("a").children("a").attr("href");
        //find the article description
      ...
      $("div.col-sm-7").each(function(i, element) {
        ...
        var link = "https://www.aljazeera.com" + $(element).children("a").children("a").attr("href");
        //find the article description
        //var img_url = $(element).find("div.topFeature-sblock-wr").find("a").children("img").eq(2).attr('src');
